...
$uploadsBase = '../admin/uploads/'; // photo folder path
// get data from db to localStorage using json
...
<?php $page_title= "Men Shoes"; include __DIR__ . '/includes/navbar.php'; ?>

<div class="container my-5">
  <h2 class="mb-4 text-center">Men's Shoes</h2>
...
const cart = {
  ...
  async fetchProducts() {
    try {
      const res = await fetch('men_shoes.php?api=products', { cache: 'no-store' });
  ...
  renderProducts() {
    ...
    if (productsArr.length === 0) {
      container.innerHTML = '<div class="col-12 text-center text-muted">No men\'s shoes found.</div>';
      return;
    }
